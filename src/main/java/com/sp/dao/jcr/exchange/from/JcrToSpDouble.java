 ...
 */
@Service("JcrToSpDouble")
public class JcrToSpDouble implements JcrToSp<Double> {
    ...
    public FieldValue<Double> apply(Node node) {
        try {
            ...
            return FieldValue.getFieldValue( JcrDaoUtils.getField(node, serialization) , value.getDouble());
        }catch (Exception e){
